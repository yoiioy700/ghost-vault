...
**Re{define} Hackathon Submission - Open Track**
...
## Hackathon Narrative Alignment (Open Track)
* **Open Innovation**: Inheritance is a neglected area in DeFi. By building on Starknet, Ghost Vault utilizes cheap computation and scalable state to handle constant "ping" transactions (check-ins) without pricing out users. This creates a highly accessible web3 will-and-testament primitive.
